...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(tf.float32, (Config.batch_size, Config.n_features), 'input')
        self.labels_placeholder = tf.placeholder(tf.int32, (Config.batch_size, Config.n_classes), 'labels')
